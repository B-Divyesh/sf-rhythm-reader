# Rhythm Reader: tap-in rhythm sight-reading trainer with real-music patterns and honest feedback (`rhythm-reader`) — factory product contract

This repository is one product built by the Param Factory. It ships at
`https://rhythm-reader.sociobot.in`. Artifact class: `static-web`.
